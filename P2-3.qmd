...
![Presents an overview of missing rows by features of the myLCdata_dirty variable. The home_ownership feature is the most complete and the only one categorized as good.](missing_data_profile_from_DataExplorer.png){width="608"}
